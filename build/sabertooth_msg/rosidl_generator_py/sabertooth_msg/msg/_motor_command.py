    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sabertooth_msg.msg.MotorCommand')
            logger.debug(
...
class MotorCommand(metaclass=Metaclass_MotorCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.drive_speed = kwargs.get('drive_speed', int())
        self.steer_speed = kwargs.get('steer_speed', int())
    ...
    def __eq__(self, other):
        ...
        if self.direction != other.direction:
            return False
        if self.drive_speed != other.drive_speed:
            return False
    ...
    def drive_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'drive_speed' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'drive_speed' field must be an integer in [-2147483648, 2147483647]"
    ...
    def steer_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'steer_speed' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'steer_speed' field must be an integer in [-2147483648, 2147483647]"
