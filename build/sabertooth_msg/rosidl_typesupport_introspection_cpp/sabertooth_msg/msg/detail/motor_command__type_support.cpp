...
{
  new (message_memory) sabertooth_msg::msg::MotorCommand(_init);
}

void MotorCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sabertooth_msg::msg::MotorCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCommand_message_member_array[3] = {
  {
    ...
    offsetof(sabertooth_msg::msg::MotorCommand, direction),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sabertooth_msg::msg::MotorCommand, drive_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sabertooth_msg::msg::MotorCommand, steer_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(sabertooth_msg::msg::MotorCommand),
...
{
  return &::sabertooth_msg::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sabertooth_msg, msg, MotorCommand)() {
  return &::sabertooth_msg::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
